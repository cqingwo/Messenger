...
public class UserInfo implements Serializable {
    ...
    public UserInfo(int uid, String username, String email, String mobile, String password, int userrid, int storeid, int mallagid, String nickname, String avatar, int paycredits, int rankcredits, int verifyemail, int verifymobile, Date liftbantime, String salt) {
        this.uid = uid;
