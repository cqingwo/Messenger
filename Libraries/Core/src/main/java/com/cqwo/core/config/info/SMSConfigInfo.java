...
// XML文件中的根标识
@XmlRootElement(name = "SMSConfigInfo")
public class SMSConfigInfo implements IConfigInfo {
    ...
    public SMSConfigInfo(String url, int userid, String account, String password, String sign, String findpwdbody, String scverifybody, String sctraverifybody, String scupdatebody, String webcomebody) {
        this.url = url;
        this.userid = userid;
