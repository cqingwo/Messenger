...
// XML文件中的根标识
@XmlRootElement(name = "EmailConfigInfo")
public class EmailConfigInfo implements IConfigInfo {
    ...
    public EmailConfigInfo(String host, int port, String username, String password, String from, String fromname, String findpwdbody, String scverifybody, String scupdatebody, String webcomebody) {
        this.host = host;
        this.port = port;
        this.username = username;
        this.password = password;
